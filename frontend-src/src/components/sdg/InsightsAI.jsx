...
const InsightsAI = () => {
  // Data dummy untuk insights, nantinya bisa diambil dari API Anda
  const insightsData = [
    {
      id: 1,
  ...
  return (
    <div className="bg-[#1e1b4b] rounded-2xl p-6 text-white h-full flex flex-col shadow-lg relative overflow-hidden">
      ...
      {/* Tombol Bawah */}
      <button className="mt-6 w-full py-3 px-4 border border-white/20 rounded-xl text-sm font-medium hover:bg-white/10 transition-colors flex justify-center items-center gap-2 relative z-10">
        Lihat semua insight
