  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-6 md:p-8">
      <div className="flex justify-between items-end mb-6">
        ...
        <Link to="/sdgs" className="text-sm text-blue-600 hover:text-blue-800 font-semibold transition-colors pb-0.5">
          {t('sdg_distribution.view_all')}
        </Link>
      </div>

      {!hasData ? (
        <div className="flex items-center justify-center h-[260px] text-center text-sm text-gray-500 px-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-10">
          <div className="relative w-full md:w-[260px] shrink-0 h-[260px] flex justify-center items-center">
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-10">
              ...
              <span className="text-sm font-medium text-gray-500 mt-1">{t('sdg_distribution.centre_label')}</span>
            </div>
