    ...
    <div className="relative w-full overflow-hidden font-sans">
      ...
      <div className="pointer-events-auto relative z-10 mx-auto max-w-7xl px-4 pb-16 pt-12 sm:px-6 lg:px-8 lg:pb-24">
        <div className="flex w-full flex-col justify-center text-center lg:w-[52%] lg:text-left">
          ...
          <span className="mx-auto mb-6 inline-flex w-max items-center gap-2 rounded-full border border-slate-200 bg-white px-3.5 py-1.5 text-[13px] font-medium text-slate-600 shadow-sm lg:mx-0">
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row lg:justify-start">
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-slate-900 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-slate-800 sm:w-auto"
            >
              {t('hero.cta_explore')}
            ...
            <button
              onClick={scrollToCta}
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition-colors hover:border-slate-400 hover:bg-slate-50 sm:w-auto"
            >
              {t('hero.cta_analyze')}
