            ...
            <>
              ...
              <div className="bg-[#1e1b4b] px-6 pt-6 pb-10 shrink-0">
                <div className="flex items-center justify-between mb-6">
                  ...
                  >
                    <svg fill="currentColor" viewBox="0 0 16 16" class="h-3 w-3">
                        <path d="M0 14.545L1.455 16 8 9.455 14.545 16 16 14.545 9.455 8 16 1.455 14.545 0 8 6.545 1.455 0 0 1.455 6.545 8z" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round" stroke="none"></path>
                    </svg>
                  </button>
                </div>
