        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <select value={statusFilter} onChange={(e) => { setStatusFilter(e.target.value); setCurrentPage(1); }}
              className="px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
              ...
              {paginated.length > 0 ? paginated.map((article) => (
                ...
                <tr>
                  <td colSpan="8" className="px-6 py-12 text-center text-gray-500">
                    ...
                    <p className="text-sm mt-1">{t('table.empty_desc')}</p>
                  </td>
                </tr>
              )}
            </tbody>
