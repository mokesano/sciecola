          ...
          <div className="flex-grow">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {collection?.tags.map((tag, idx) => (
                <span key={idx} className="px-3 py-1 bg-indigo-50 text-indigo-700 rounded-md text-sm font-medium">#{tag}</span>
              ))}
            </div>
          </div>
            ...
            >
              ...
              <div className="p-4">
                <div className="flex justify-between items-start mb-2">
                  <span className="px-2 py-1 bg-indigo-50 text-indigo-700 rounded text-[10px] font-bold uppercase tracking-wide">
                    {item.type}
                  </span>
                  <button 
                ...
                <p className="text-sm text-gray-600 mb-2 line-clamp-1">{item.authors.join(', ')}</p>
                
                <p className="text-xs text-gray-500 mb-3">{item.journal} • {formatDate(item.publishedDate)}</p>
