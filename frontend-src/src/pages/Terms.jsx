...
// Render one legal section from the i18n tree. Content strings are trusted
// (from our own JSON), so dangerouslySetInnerHTML is safe here and lets us
// keep inline <strong>/<em>/<a> markup inside the translated copy.
